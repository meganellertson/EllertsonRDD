...
estout Male White Age Accident, cells(b(star fmt(4)) se(par fmt(4))) stats(N, labels(N)) label legend varlabels(RD_Estimate "Panel A DUI Threshold") using example.tex
...
>>>>>>> 23b1f8682e56e923e63d0f86f80d3a0650129e6e
